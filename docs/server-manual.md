  Hytale Server Manual – Hypixel Studios                 [Skip to main content](#main-content)

 [![Hypixel Studios Help Center home page](/hc/theming_assets/01KAESWX0FGCNWG8NN4SEBBADD) Support](/hc/en-us "Home")

[Contact Us](/hc/en-us/requests/new)

[Sign in](/hc/en-us/signin?return_to=https%3A%2F%2Fsupport.hytale.com%2Fhc%2Fen-us%2Farticles%2F45326769420827-Hytale-Server-Manual "Opens a dialog")

var redirects = { 5376878289810: "https://hypixel.net/terms", 5376886559250: "https://hypixel.net/privacy", 360019603420: "https://store.hypixel.net/terms" }; if (redirects.hasOwnProperty(45326769420827)) { window.location.href = redirects\[45326769420827\]; }

1.  [Hypixel Studios](/hc/en-us)
2.  [Game Features](/hc/en-us/categories/45383370472731-Game-Features)
3.  [Multiplayer](/hc/en-us/sections/45383871296539-Multiplayer)

Articles in this section

*   [Joining Friends](/hc/en-us/articles/45324238811291-Joining-Friends)
*   [Server Provider Authentication Guide](/hc/en-us/articles/45328341414043-Server-Provider-Authentication-Guide)
*   [Hytale Server Manual](/hc/en-us/articles/45326769420827-Hytale-Server-Manual)

Hytale Server Manual
====================

*   January 12, 2026 03:12
*   Updated
...
Java installation, server files, system requirements

[Running a Hytale Server](#running-a-hytale-server)

Launch commands, authentication, ports, firewall, file structure

[Tips & Tricks](#tips-tricks)

Mods, AOT cache, Sentry, recommended plugins, view distance

[Multiserver Architecture](#multiserver-architecture)

Player referral, redirects, fallbacks, building proxies

[Misc Details](#misc-details)

JVM arguments, protocol updates, configuration files

[Future Additions](#future-additions)

Server discovery, parties, integrated payments, SRV records, API endpoints
...
High player or entity counts (NPCs, mobs)

RAM

Large loaded world area (high view distance, players exploring independently)
...
Linux: $XDG\_DATA\_HOME/Hytale/install/release/package/game/latest
...
Or visit: https://accounts.hytale.com/device?user\_code=ABCD-1234
===================================================================
Waiting for authorization (expires in 900 seconds)...

\[User completes authorization in browser\]

> Authentication successful! Mode: OAUTH\_DEVICE
...
If you need to authenticate a large amount of servers or dynamically authenticate servers automatically, please read the [Server Provider Authentication Guide](/hc/en-us/articles/45328341414043) for detailed information.
...
[Nitrado:Query](https://github.com/nitrado/hytale-plugin-query)

Exposes server status (player counts, etc.) via HTTP

[Nitrado:PerformanceSaver](https://github.com/nitrado/hytale-plugin-performance-saver)

Dynamically limits view distance based on resource usage

[ApexHosting:PrometheusExporter](https://github.com/apexhosting/hytale-plugin-prometheus)
...
Servers must adhere to operator guidelines and community standards

**Self-Rating**

Operators must accurately rate their server content. Ratings power content filtering and parental controls

**Enforcement**

Servers violating their self-rating are subject to enforcement actions per server operator policies
...
Process payments using our built-in payment gate
...
*   [Server Provider Authentication Guide](/hc/en-us/related/click?data=BAh7CjobZGVzdGluYXRpb25fYXJ0aWNsZV9pZGwrCJswsNM5KToYcmVmZXJyZXJfYXJ0aWNsZV9pZGwrCBt6%2FXU5KToLbG9jYWxlSSIKZW4tdXMGOgZFVDoIdXJsSSJLL2hjL2VuLXVzL2FydGljbGVzLzQ1MzI4MzQxNDE0MDQzLVNlcnZlci1Qcm92aWRlci1BdXRoZW50aWNhdGlvbi1HdWlkZQY7CFQ6CXJhbmtpBg%3D%3D--1e30067d06cc0a315aede2719e9dfe032e8e0ef8)
*   [Joining Friends](/hc/en-us/related/click?data=BAh7CjobZGVzdGluYXRpb25fYXJ0aWNsZV9pZGwrCJtwJ984KToYcmVmZXJyZXJfYXJ0aWNsZV9pZGwrCBt6%2FXU5KToLbG9jYWxlSSIKZW4tdXMGOgZFVDoIdXJsSSI2L2hjL2VuLXVzL2FydGljbGVzLzQ1MzI0MjM4ODExMjkxLUpvaW5pbmctRnJpZW5kcwY7CFQ6CXJhbmtpBw%3D%3D--6b84e75ac6414c1977da0c5849f0f1a346b96bf4)
*   [How to Download and Play Hytale](/hc/en-us/related/click?data=BAh7CjobZGVzdGluYXRpb25fYXJ0aWNsZV9pZGwrCJs84580KToYcmVmZXJyZXJfYXJ0aWNsZV9pZGwrCBt6%2FXU5KToLbG9jYWxlSSIKZW4tdXMGOgZFVDoIdXJsSSJGL2hjL2VuLXVzL2FydGljbGVzLzQ1MzA1OTk3NTA3NzM5LUhvdy10by1Eb3dubG9hZC1hbmQtUGxheS1IeXRhbGUGOwhUOglyYW5raQg%3D--7843f7ee087c19cea92cfefe7bd5c2a5d3eb04af)
*   [Frequently Asked Questions](/hc/en-us/related/click?data=BAh7CjobZGVzdGluYXRpb25fYXJ0aWNsZV9pZGwrCBtyw2PcKDoYcmVmZXJyZXJfYXJ0aWNsZV9pZGwrCBt6%2FXU5KToLbG9jYWxlSSIKZW4tdXMGOgZFVDoIdXJsSSJBL2hjL2VuLXVzL2FydGljbGVzLzQ0OTI3MDMxNjY5Mjc1LUZyZXF1ZW50bHktQXNrZWQtUXVlc3Rpb25zBjsIVDoJcmFua2kJ--fc118cbd98a20b57d869f3c3e28dd459148b7757)
*   [Refund Policy and Available Payment Methods](/hc/en-us/related/click?data=BAh7CjobZGVzdGluYXRpb25fYXJ0aWNsZV9pZGwrCJt57koJKToYcmVmZXJyZXJfYXJ0aWNsZV9pZGwrCBt6%2FXU5KToLbG9jYWxlSSIKZW4tdXMGOgZFVDoIdXJsSSJSL2hjL2VuLXVzL2FydGljbGVzLzQ1MTE5ODg4NTg3MTYzLVJlZnVuZC1Qb2xpY3ktYW5kLUF2YWlsYWJsZS1QYXltZW50LU1ldGhvZHMGOwhUOglyYW5raQo%3D--4898122e330ea71627cd7cc4071045a89e75c150)

Follow us[](https://www.youtube.com/Hytale "Hytale YouTube Channel")[](https://twitter.com/Hytale "Hytale Twitter Account")[](https://www.instagram.com/HytaleGame/ "Hytale Instagram Account")[](https://www.tiktok.com/@hytale "Hytale TikTok Account")[](https://www.facebook.com/HytaleGame "Hytale Facebook Page")[](https://bsky.app/profile/hytale.bsky.social "Hytale Bluesky Account")[](https://discord.gg/hytale "Hytale Discord Server")

[![Hypixel Studios](/hc/theming_assets/01KAESWX0FGCNWG8NN4SEBBADD)](https://hytale.com)

*   [Home](https://hytale.com)
*   [Support](https://support.hytale.com)
*   [Blog](https://hytale.com/news)
*   [Media](https://hytale.com/media)
*   [The Game](https://hytale.com/game)
*   [Community](https://hytale.com/community)
*   [Privacy](https://hytale.com/privacy)
*   [Cookie Policy](https://hytale.com/cookie-policy)
*   [Security](https://hytale.com/security)
*   [About & Contact](https://hytale.com/about)

©2025 HYPIXEL STUDIOS CANADA INC. ALL RIGHTS RESERVED.  
All trademarks referenced herein are the properties of their respective owners.

/\* Greetings sourcecode lurker! This is for internal Zendesk and legacy usage, we don't support or guarantee any of these values so please don't build stuff on top of them. \*/ HelpCenter = {}; HelpCenter.account = {"subdomain":"hypixelstudios","environment":"production","name":"Hypixel Studios"}; HelpCenter.user = {"identifier":"da39a3ee5e6b4b0d3255bfef95601890afd80709","email":null,"name":"","role":"anonymous","avatar\_url":"https://assets.zendesk.com/hc/assets/default\_avatar.png","is\_admin":false,"organizations":\[\],"groups":\[\]}; HelpCenter.internal = {"asset\_url":"//static.zdassets.com/hc/assets/","web\_widget\_asset\_composer\_url":"https://static.zdassets.com/ekr/snippet.js","current\_session":{"locale":"en-us","csrf\_token":null,"shared\_csrf\_token":null},"usage\_tracking":{"event":"article\_viewed","data":"--ec5383bea5b9c4aa2bd8ff86ad792cac0d83cc02","url":"https://support.hytale.com/hc/activity"},"current\_record\_id":"45326769420827","current\_record\_url":"/hc/en-us/articles/45326769420827-Hytale-Server-Manual","current\_record\_title":"Hytale Server Manual","current\_text\_direction":"ltr","current\_brand\_id":41690543366171,"current\_brand\_name":"Hypixel Studios","current\_brand\_url":"https://hypixelstudios.zendesk.com","current\_brand\_active":true,"current\_path":"/hc/en-us/articles/45326769420827-Hytale-Server-Manual","show\_autocomplete\_breadcrumbs":true,"user\_info\_changing\_enabled":false,"has\_user\_profiles\_enabled":false,"has\_end\_user\_attachments":true,"user\_aliases\_enabled":false,"has\_anonymous\_kb\_voting":false,"has\_multi\_language\_help\_center":true,"show\_at\_mentions":false,"embeddables\_config":{"embeddables\_web\_widget":false,"embeddables\_help\_center\_auth\_enabled":false,"embeddables\_connect\_ipms":false},"answer\_bot\_subdomain":"static","gather\_plan\_state":"subscribed","has\_article\_verification":false,"has\_gather":true,"has\_ckeditor":false,"has\_community\_enabled":false,"has\_community\_badges":true,"has\_community\_post\_content\_tagging":false,"has\_gather\_content\_tags":true,"has\_guide\_content\_tags":true,"has\_user\_segments":true,"has\_answer\_bot\_web\_form\_enabled":false,"has\_garden\_modals":false,"theming\_cookie\_key":"hc-da39a3ee5e6b4b0d3255bfef95601890afd80709-2-preview","is\_preview":false,"has\_search\_settings\_in\_plan":true,"theming\_api\_version":2,"theming\_settings":{"brand\_color":"#edb548","brand\_text\_color":"#FFFFFF","text\_color":"#b7cedd","link\_color":"#edb548","background\_color":"#15243a","heading\_font":"'Lexend', sans-serif","text\_font":"'Nunito Sans', sans-serif","logo":"/hc/theming\_assets/01KAESWX0FGCNWG8NN4SEBBADD","favicon":"/hc/theming\_assets/01KAESWXBH57FS9B4NJC6SXTH1","homepage\_background\_image":"/hc/theming\_assets/01KAESWXTYAQ5QXA76ZM9KEDP1","community\_background\_image":"/hc/theming\_assets/01K7HH239QRX7PHJGZ1BQ9FMGD","community\_image":"/hc/theming\_assets/01KAESWYKEFCQVCCCRJFC3GFA1","instant\_search":true,"scoped\_kb\_search":true,"scoped\_community\_search":false,"show\_recent\_activity":false,"show\_articles\_in\_section":true,"show\_article\_author":false,"show\_article\_comments":false,"show\_follow\_article":false,"show\_recently\_viewed\_articles":true,"show\_related\_articles":true,"show\_article\_sharing":false,"show\_follow\_section":false,"show\_follow\_post":false,"show\_post\_sharing":false,"show\_follow\_topic":false},"has\_pci\_credit\_card\_custom\_field":false,"help\_center\_restricted":false,"is\_assuming\_someone\_else":false,"flash\_messages":\[\],"user\_photo\_editing\_enabled":true,"user\_preferred\_locale":"en-us","base\_locale":"en-us","login\_url":"/hc/en-us/signin?return\_to=https%3A%2F%2Fsupport.hytale.com%2Fhc%2Fen-us%2Farticles%2F45326769420827-Hytale-Server-Manual","has\_alternate\_templates":false,"has\_custom\_statuses\_enabled":true,"has\_hc\_generative\_answers\_setting\_enabled":true,"has\_generative\_search\_with\_zgpt\_enabled":false,"has\_suggested\_initial\_questions\_enabled":false,"has\_guide\_service\_catalog":true,"has\_service\_catalog\_search\_poc":false,"has\_service\_catalog\_itam":false,"has\_csat\_reverse\_2\_scale\_in\_mobile":false,"has\_knowledge\_navigation":false,"has\_unified\_navigation":false,"has\_csat\_bet365\_branding":false,"version":"v26806","dev\_mode":false};
